...
module.exports = {
    ...
    isim: "b-developerrole", 
    alternatifler: ["botlist-developerrole", "geliştirici-rol", "geliştirici-rol"],
     kullanımı:"help",
    ...
    çalıştır: async (client, message, args, interaction) => {
        ...
        if(en) {
            ...
            const aset = new Discord.MessageEmbed()
                .setDescription(`<:hammer:897863047991947324> ・ The developer role already been set up.`)
                .setFooter(`Elenor - Botlist System`)
            
            const set = new Discord.MessageEmbed()
                .setDescription(`<:hammer:897863047991947324> ・ The developer role has been successfully set up.`)
                .setFooter(`Elenor - Botlist System`)
            
            const areset = new Discord.MessageEmbed()
                .setDescription(`<:hammer:897863047991947324> ・ The developer role is not already set.`)
                .setFooter(`Elenor - Botlist System`)
            
            const reset = new Discord.MessageEmbed()
                .setDescription(`<:hammer:897863047991947324> ・ The developer role has been successfully reset.`)
                .setFooter(`Elenor - Botlist System`)
            ...
            const m = new Discord.MessageEmbed()
              ...
              if (args[0] == 'set' | args[0] == 'Set') {
                ...
                if(db.has(`developerrole.${message.guild.id}`)) return message.channel.send({embeds: [aset]})
                db.set(`developerrole.${message.guild.id}`, officer.id)
                  message.channel.send({embeds: [set]})
              }
              if (args[0] == 'reset' | args[0] == 'Reset') {
                    if(!db.has(`developerrole.${message.guild.id}`)) return message.channel.send({embeds: [areset]})
                db.delete(`developerrole.${message.guild.id}`)
            ...
            const permerr = new Discord.MessageEmbed()
                ...
                const aset = new Discord.MessageEmbed()
                    .setDescription(`<:hammer:897863047991947324> ・ Geliştirici rolü zaten ayarlı.`)
                    .setFooter(`Elenor - Botlist Sistem`)
                
                const set = new Discord.MessageEmbed()
                    .setDescription(`<:hammer:897863047991947324> ・ Geliştirici rolü başarıyla ayarlandı.`)
                    .setFooter(`Elenor - Botlist Sistem`)
                
                const areset = new Discord.MessageEmbed()
                    .setDescription(`<:hammer:897863047991947324> ・ Geliştirici rolü zaten ayarlı değil.`)
                    .setFooter(`Elenor - Botlist Sistem`)
                
                const reset = new Discord.MessageEmbed()
                    .setDescription(`<:hammer:897863047991947324> ・ Geliştirici rolü başarıyla sıfırlandı.`)
                    .setFooter(`Elenor - Botlist Sistem`)
