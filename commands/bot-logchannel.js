...
module.exports = {
    ...
    isim: "b-logchannel", 
    alternatifler: ["botlist-logchannel", "botlog-kanal", "bot-log-kanal"],
     kullanımı:"help",
    ...
    çalıştır: async (client, message, args, interaction) => {
        ...
        if(en) {
            ...
            const aset = new Discord.MessageEmbed()
                .setDescription(`<:hammer:897863047991947324> ・ The log channel already been set up.`)
                .setFooter(`Elenor - Botlist System`)
            
            const set = new Discord.MessageEmbed()
                .setDescription(`<:hammer:897863047991947324> ・ The log channel has been successfully set up.`)
                .setFooter(`Elenor - Botlist System`)
            
            const areset = new Discord.MessageEmbed()
                .setDescription(`<:hammer:897863047991947324> ・ The log channel is not already set.`)
                .setFooter(`Elenor - Botlist System`)
            
            const reset = new Discord.MessageEmbed()
                .setDescription(`<:hammer:897863047991947324> ・ The log channel has been successfully reset.`)
                .setFooter(`Elenor - Botlist System`)
            ...
            const m = new Discord.MessageEmbed()
              ...
              if (args[0] == 'set' | args[0] == 'Set') {
                ...
                if(db.has(`botlog.${message.guild.id}`)) return message.channel.send({embeds: [aset]})
                db.set(`botlog.${message.guild.id}`, officer.id)
                  message.channel.send({embeds: [set]})
              }
              if (args[0] == 'reset' | args[0] == 'Reset') {
                    if(!db.has(`botlog.${message.guild.id}`)) return message.channel.send({embeds: [areset]})
            ...
            const permerr = new Discord.MessageEmbed()
                ...
                const aset = new Discord.MessageEmbed()
                    .setDescription(`<:hammer:897863047991947324> ・ Bot log kanalı zaten ayarlı.`)
                    .setFooter(`Elenor - Botlist Sistem`)
                
                const set = new Discord.MessageEmbed()
                    .setDescription(`<:hammer:897863047991947324> ・ Bot log kanalı başarıyla ayarlandı.`)
                    .setFooter(`Elenor - Botlist Sistem`)
                
                const areset = new Discord.MessageEmbed()
                    .setDescription(`<:hammer:897863047991947324> ・ Bot log kanalı zaten ayarlı değil.`)
                    .setFooter(`Elenor - Botlist Sistem`)
                
                const reset = new Discord.MessageEmbed()
                    .setDescription(`<:hammer:897863047991947324> ・ Bot log kanalı başarıyla sıfırlandı.`)
                    .setFooter(`Elenor - Botlist Sistem`)
