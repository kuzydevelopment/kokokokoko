...
module.exports = {
    ...
    isim: "b-officerrole", 
    alternatifler: ["botlist-officerrole", "yetkilirol", "yetkili-rol"],
     kullanımı:"help",
    ...
    çalıştır: async (client, message, args, interaction) => {
        ...
        if(en) {
            ...
            const aset = new Discord.MessageEmbed()
                .setDescription(`<:hammer:897863047991947324> ・ The officer role already been set up.`)
                .setFooter(`Elenor - Botlist System`)
            
            const set = new Discord.MessageEmbed()
                .setDescription(`<:hammer:897863047991947324> ・ The officer role has been successfully set up.`)
                .setFooter(`Elenor - Botlist System`)
            
            const areset = new Discord.MessageEmbed()
                .setDescription(`<:hammer:897863047991947324> ・ The officer role is not already set.`)
                .setFooter(`Elenor - Botlist System`)
            
            const reset = new Discord.MessageEmbed()
                .setDescription(`<:hammer:897863047991947324> ・ The officer role has been successfully reset.`)
                .setFooter(`Elenor - Botlist System`)
            ...
            const m = new Discord.MessageEmbed()
              ...
              if (args[0] == 'set' | args[0] == 'Set') {
                ...
                if(db.has(`officerrole.${message.guild.id}`)) return message.channel.send({embeds: [aset]})
                db.set(`officerrole.${message.guild.id}`, officer.id)
                  message.channel.send({embeds: [set]})
              }
              if (args[0] == 'reset' | args[0] == 'Reset') {
                    if(!db.has(`officerrole.${message.guild.id}`)) return message.channel.send({embeds: [areset]})
                db.delete(`officerrole.${message.guild.id}`)
            ...
            const permerr = new Discord.MessageEmbed()
                ...
                const aset = new Discord.MessageEmbed()
                    .setDescription(`<:hammer:897863047991947324> ・ Botlist yetkilisi rolü zaten ayarlı.`)
                    .setFooter(`Elenor - Botlist Sistem`)
                
                const set = new Discord.MessageEmbed()
                    .setDescription(`<:hammer:897863047991947324> ・ Botlist yetkilisi rolü başarıyla ayarlandı.`)
                    .setFooter(`Elenor - Botlist Sistem`)
                
                const areset = new Discord.MessageEmbed()
                    .setDescription(`<:hammer:897863047991947324> ・ Botlist yetkilisi rolü zaten ayarlı değil.`)
                    .setFooter(`Elenor - Botlist Sistem`)
                
                const reset = new Discord.MessageEmbed()
                    .setDescription(`<:hammer:897863047991947324> ・ Botlist yetkilisi rolü başarıyla sıfırlandı.`)
                    .setFooter(`Elenor - Botlist Sistem`)
